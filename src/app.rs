...
use crate::views::{Dashboard, NotFound, Services};
                    ...
                    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="flex items-center justify-between h-16">
                            ...
                            <div class="flex gap-2">
                                <button class="px-4 py-1 rounded bg-purple-600 text-white font-medium">
                                    Dashboard
                                </button>
                                <button class="px-4 py-1 rounded bg-gray-700 text-white border border-gray-600">
                                    Services
                                </button>
                            </div>
                        </div>
